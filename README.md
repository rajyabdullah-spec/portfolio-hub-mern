...
- Modern UI & Responsive Design: Built using React 18, Framer Motion, Tailwind CSS, and Lucide React icons.
...
- Frontend: React 18, Vite, React Router DOM v6, Framer Motion, Axios, Tailwind CSS, Lucide Icons
